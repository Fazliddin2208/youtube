...
import side from "./sidebar.module.scss";
  ...
  return (
    pathname == "/" && (
      <div className={side.sidebar}>
        <div className={side.sidebar__top}>
          <FontAwesomeIcon icon={faBars} className={side.sidebar__bars} />

          <Link href={"/"}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className={side.sidebar__logo}
              viewBox="0 0 90 20"
              focusable="false"
              style={{
                pointerEvents: "none",
        ...
        <div className={side.sidebar__body}>
          <ul>
